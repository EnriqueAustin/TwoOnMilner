...
const experiences = [
  {
    icon: Trees,
    image: "/images/OAKTREECOTTAGE/490410862.jpg",
    title: "Leafy Privacy",
    text: "Detached cottages, private entrances, terraces, and a quiet garden feel.",
  },
  {
    icon: Coffee,
    image: "/images/OAKTREECOTTAGE/490410861.jpg",
          ...
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-end p-6">
                ...
                <p className="font-body text-white/74 text-sm leading-relaxed">{exp.text}</p>
              </div>
            </motion.div>
          ))}
        </div>
